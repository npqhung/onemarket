 ...
 */
public class LoadSearchTask extends AsyncTask<String, Integer, ProductListResponse[]> {

    private static final String TAG = LoadSearchTask.class.getName();
    ...
    public LoadSearchTask(Context context, ProductAdapter productAdapter, LinkedList criteria) {
